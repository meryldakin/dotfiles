...
# A function to CD into ironboard from anywhere
function ironboard {
  cd /Users/$USER/Development/flatiron-labs/ironboard
}


# A function to CD into labs from anywhere
function labs {
  cd /Users/$USER/Development/flatiron-labs
}
...
function gitgimme () {
  ...
  do git branch --track $remote &> /dev/null;
  done
}
